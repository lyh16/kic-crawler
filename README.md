...
&nbsp;&nbsp;&nbsp;♣크롤링 주기는 학교 담당 부서들과의 상의 하 30분(수강 신청 등 특수 사례에도 문제없는 정도)으로 설정함. 국제학과 누리집은 학교 도메인(khu.ac.kr)을 사용하지만 서버는 별도로 두고 있는 것으로 파악함. 그러나 크롤링 주기는 학교 서버 접속 시 권장받은 기준에 준하도록 설정함.<br>
